...
## Clock Signal
set_property -dict { PACKAGE_PIN H16    IOSTANDARD LVCMOS33 } [get_ports { CLK100MHZ }]; #IO_L13P_T2_MRCC_35 Sch=SYSCLK
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { CLK100MHZ }];#set
...
## RGB LEDs
#set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { B_RGB[0] }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
#set_property -dict { PACKAGE_PIN G17    IOSTANDARD LVCMOS33 } [get_ports { B_RGB[1] }]; #IO_L16P_T2_35 Sch=LED4_G
#set_property -dict { PACKAGE_PIN N15    IOSTANDARD LVCMOS33 } [get_ports { B_RGB[2] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=LED4_R
#set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports { A_RGB[0] }]; #IO_0_35 Sch=LED5_B
#set_property -dict { PACKAGE_PIN L14    IOSTANDARD LVCMOS33 } [get_ports { A_RGB[1] }]; #IO_L22P_T3_AD7P_35 Sch=LED5_G
#set_property -dict { PACKAGE_PIN M15    IOSTANDARD LVCMOS33 } [get_ports { A_RGB[2] }]; #IO_L23N_T3_35 Sch=LED5_R
...
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { SEG[2] }]; #IO_L7P_T1_34 Sch=JA2_P (Pin 3)
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { SEG[3] }]; #IO_L7N_T1_34 Sch=JA2_N (Pin 4)
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { SEG[4] }]; #IO_L12P_T1_MRCC_34 Sch=JA3_P (Pin 7)
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { SEG[5] }]; #IO_L12N_T1_MRCC_34 Sch=JA3_N (Pin 8)
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { SEG[6] }]; #IO_L22P_T3_34 Sch=JA4_P (Pin 9)
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { ja_n[4] }]; #IO_L22N_T3_34 Sch=JA4_N (Pin 10)

## Pmod Header JB
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { AN[0] }]; #IO_L8P_T1_34 Sch=JB1_P (Pin 1)
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { AN[1] }]; #IO_L8N_T1_34 Sch=JB1_N (Pin 2)
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { AN[2] }]; #IO_L1P_T0_34 Sch=JB2_P (Pin 3)
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { AN[3] }]; #IO_L1N_T0_34 Sch=JB2_N (Pin 4)
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { DIGIT3[0] }]; #IO_L19N_T3_VREF_13  Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { DIGIT3[1] }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { DIGIT3[2] }]; #IO_L22P_T3_13        Sch=CK_IO28
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { DIGIT3[3] }]; #IO_L11P_T1_SRCC_13   Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { DIGIT2[0] }]; #IO_L11N_T1_SRCC_13   Sch=CK_IO30
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { DIGIT2[1] }]; #IO_L17N_T2_13        Sch=CK_IO31
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { DIGIT2[2] }]; #IO_L15P_T2_DQS_13    Sch=CK_IO32
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { DIGIT2[3] }]; #IO_L21N_T3_DQS_13    Sch=CK_IO33
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { DIGIT1[0] }]; #IO_L16P_T2_13        Sch=CK_IO34
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { DIGIT1[1] }]; #IO_L22N_T3_13        Sch=CK_IO35
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { DIGIT1[2] }]; #IO_L13N_T2_MRCC_13   Sch=CK_IO36
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { DIGIT1[3] }]; #IO_L13P_T2_MRCC_13   Sch=CK_IO37
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { DIGIT0[0] }]; #IO_L15N_T2_DQS_13    Sch=CK_IO38
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { DIGIT0[1] }]; #IO_L14N_T2_SRCC_13   Sch=CK_IO39
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { DIGIT0[2] }]; #IO_L16N_T2_13        Sch=CK_IO40
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { DIGIT0[3] }]; #IO_L14P_T2_SRCC_13   Sch=CK_IO41
